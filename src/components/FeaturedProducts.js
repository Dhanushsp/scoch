...
const FeaturedProducts = () => {
  ...
  // Get first 2 products as featured products
  const featuredProducts = productsData.slice(0, 2);
          ...
          {featuredProducts.map((product, index) => (
            ...
            >
              ...
              <div className="mt-4 md:mt-6 text-center">
                ...
                {/* <button className="w-full py-3 md:py-4 px-6 bg-black text-white font-sans font-medium rounded-xl hover:bg-gray-800 transition-colors duration-200">
                  View Details
                </button> */}
              </div>
            </div>
