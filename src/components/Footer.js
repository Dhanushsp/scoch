        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-soft-white/80 hover:text-soft-white transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#clothes" className="text-soft-white/80 hover:text-soft-white transition-colors duration-200">
                  Clothes
                </a>
              </li>
              <li>
                <a href="#perfumes" className="text-soft-white/80 hover:text-soft-white transition-colors duration-200">
                  Perfumes
                </a>
              </li>
              <li>
                <a href="#accessories" className="text-soft-white/80 hover:text-soft-white transition-colors duration-200">
                  Accessories
                </a>
              </li>
              <li>
                <a href="#sale" className="text-soft-white/80 hover:text-soft-white transition-colors duration-200">
                  Sale
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-soft-white/80">
